...
// Words cycle every ROTATE_MS. The CSS animation runs for ~450ms inside that window —
// leaving roughly half a second of "rest" before the next swap. Stable order so the
// hero feels intentional, not random.
